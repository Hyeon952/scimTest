...
public class DeviceDBConstants {
    public static final String DEVICE_TRANSACTION_MANAGER = "deviceTransactionManager";
    public static final String DEVICE_ENTITY_MANAGER_FACTORY = "deviceEntityManagerFactory";
